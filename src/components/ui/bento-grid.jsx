...
const BentoCard = memo(function BentoCard ({
  ...
  return (
    <div
      ...
      <div
        className={cn(
          "pointer-events-none absolute bottom-0 flex w-full translate-y-0 transform-gpu flex-row items-center p-4 opacity-100 transition-all duration-300 lg:hidden"
        )}>
